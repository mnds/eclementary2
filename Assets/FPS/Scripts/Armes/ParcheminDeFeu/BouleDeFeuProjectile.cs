...
public class BouleDeFeuProjectile : MonoBehaviour {
	
	float rayonExplosion = 5f; //zone d'effet de l'explosion
	float forceExplosion = 500f; //force de l'explosion
	float degatsExplosion = 100f; //dégâts de l'explosion... DEUFBYFUI !
...
// vous etes encore là à lire mes commentaires ? Je vous soujaite du bonheur