/**
 * \file      ComportementBossFinal.cs
 * \author    
 * \version   1.0
 * \date      7 mars 2015
 * \brief     Comportement du premier boss final.
 */
...
public class ComportementBossFinal : ActionSelonFlagsScene {
	...
	public ComportementBossFinal2 cbf2; //Pour activer l'autre boss
	...
	void Update () {
		...
		if(phaseUn) { //Pas de conditions sur temps ; le test est fait dans la boucle.
			...
			cbf2.Activer(); //On active l'autre boss
